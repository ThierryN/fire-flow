...
│  ┌──────────────────────────────────────────────────────────────┐  │
│  │                                                               │  │
│  │   C:\path\to\repos\the budgeting app\                          │  │
│  │                                                               │  │
│  │   git add .                                                   │  │
...
### Essential Git Commands for the budgeting app
...
# Navigate to project
cd C:\path\to\repos\the budgeting app
...
cd C:\path\to\repos\the budgeting app && git add . && git commit -m "fix: Quick bug fix" && git push origin main
```
...
2. Find project: the budgeting app
...
│   LOCAL DEVELOPMENT                                                  │
│   ─────────────────                                                  │
│   File: C:\path\to\repos\the budgeting app\.env.local                 │
...
```
1. Go to: https://vercel.com/dashboard
2. Select project: the budgeting app
